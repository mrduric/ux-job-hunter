...
Usage:
    ...
    3. Run: python job_hunter_share.py
...
def load_resume() -> str:
    ...
    for path in ["resume.txt", "resume.md"]:
        if os.path.exists(path):
            with open(path) as f:
                return f.read()

    # No resume file found — return placeholder with instructions
    print("\n⚠️  No resume found!")
    print("   Save your resume as 'resume.txt' in the same folder as this script.")
    print("   Or paste it into the load_resume() function in this file.\n")
    return """[PASTE YOUR RESUME TEXT HERE]

Replace this placeholder with your resume text, OR save your resume
as resume.txt in the same folder as this script.

Example format:
    Your Name
    your.email@example.com | City, State

    SUMMARY
    Brief description of your background and what you're looking for...

    EDUCATION
    University, Degree (Year)

    SKILLS
    Research Methods: ethnographic fieldwork, interviews, thematic analysis...
    Tools: Figma, Miro, Dovetail, SPSS, R, Python...
